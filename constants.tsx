...
export const CATEGORIES: CategoryOption[] = [
  ...
  },
  {
    ...
    prompt: "Generate a professional, high-quality headshot of the person in the photo. The final image must be photorealistic. It is very important to maintain the original person's facial features, hair, and expression to ensure they are still recognizable. The background should be a neutral, professional setting.",
