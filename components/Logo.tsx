...
export const Logo: React.FC = () => (
    <div className="flex items-center gap-2" aria-hidden="true">
        <svg width="36" height="36" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-indigo-600">
        ...
        <span className="text-2xl font-bold text-slate-800">MakeMeLookLike</span>
    </div>
);
